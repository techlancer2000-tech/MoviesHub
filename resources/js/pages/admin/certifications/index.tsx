...
import { create as createCertification } from '@/routes/certifications';
...
export default function Index({ certifications, filters }: Props) {
    const tableHeads = [
        'Name',
        'Code',
        'Description',
        ...
        <>
            ...
            <div className="flex flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Button asChild>
                        <Link href={createCertification()} prefetch>
